...
```bash
# Run individual test
nextflow run validation/version-topic-channels/ -plugins nf-core-utils@0.7.0
...
nextflow run validation/notification-system/ -plugins nf-core-utils@0.7.0
nextflow run validation/pipeline-utilities/ -plugins nf-core-utils@0.7.0

# With different profiles
nextflow run validation/version-topic-channels/ -plugins nf-core-utils@0.7.0 -profile test
```
